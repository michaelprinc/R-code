...
A=dccresults$DCC
B=dccresults$h
write.table(A,file="I:/15Stocks/dcc_stocks_shortfilefinal.csv",sep = ",",col.names = NA,qmethod = "double")
write.table(B,file="I:/15Stocks/varianceshortfilefinal.csv",sep = ",",col.names = NA,qmethod = "double")
