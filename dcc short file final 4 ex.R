...
A=dccresults$DCC
B=dccresults$h
write.table(A,file="I:/Stocks/dcc_stocks_shortfilefinal_ex.csv",sep = ",",col.names = NA,qmethod = "double")
write.table(B,file="I:/Stocks/varianceshortfilefinal_ex.csv",sep = ",",col.names = NA,qmethod = "double")
