mat <- read.csv(file="I:/Stocks/short file 15 stocks.csv",head=TRUE,sep=",")
...
A = diag(c(f1[2],f2[2],f3[2],f4[2],f5[2],f6[2],
      f7[2],f8[2],f9[2],f10[2],f11[2],f12[2],
	f13[2],f14[2],f15[2]))
B = diag(c(f1[3],f2[3],f3[3],f4[3],f5[3],f6[3],
      f7[3],f8[3],f9[3],f10[3],f11[3],f12[3],
	f13[3],f14[3],f15[3]))
print("6")
dccpara = c(0.1,0.8)
...
A=dccresults$DCC
B=dccresults$h
write.table(A,file="I:/Stocks/dcc_stocks_shortfilefinal.csv",sep = ",",col.names = NA,qmethod = "double")
write.table(B,file="I:/Stocks/varianceshortfilefinal.csv",sep = ",",col.names = NA,qmethod = "double")
